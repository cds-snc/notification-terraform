...
inputs = {
  ...
  alarm_warning_priority_inflight_processed_created_delta_threshold  = 50
  alarm_critical_priority_inflight_processed_created_delta_threshold = 100
  ...
  alarm_warning_priority_bulk_processed_created_delta_threshold      = 500
  alarm_critical_priority_bulk_processed_created_delta_threshold     = 100
  alarm_warning_normal_bulk_processed_created_delta_threshold        = 50
  alarm_critical_normal_bulk_processed_created_delta_threshold       = 100
  alarm_warning_bulk_bulk_processed_created_delta_threshold          = 50
  alarm_critical_bulk_bulk_processed_created_delta_threshold         = 100
