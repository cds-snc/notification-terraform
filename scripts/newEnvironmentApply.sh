...
### This script is intended to streamline the process of creating new environments and upgrading providers.
...
if [ "$RESPONSE" == "yes" ]; then
   ...
   do
      ...
      runCommand "terragrunt init --upgrade"
      runCommand "terragrunt apply -var-file $VARFILE --auto-approve"
      popd
   done
    exit 0
else
