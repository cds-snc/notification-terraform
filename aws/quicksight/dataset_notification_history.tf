...
# resource "aws_quicksight_refresh_schedule" "notification_history" {
#   data_set_id = "notification-history"
#   schedule_id = "schedule-notification-history"
#   depends_on  = [aws_cloudformation_stack.notification_history]
