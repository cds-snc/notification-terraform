...
resource "aws_lambda_function" "api" {
  ...
  environment {
    variables = {
      ...
      SQLALCHEMY_DATABASE_URI        = "postgresql://app_db_user:${var.app_db_user_password}@${var.postgres_cluster_endpoint}/${var.app_db_database_name}"
      SQLALCHEMY_DATABASE_READER_URI = "postgresql://app_db_user:${var.app_db_user_password}@${var.postgres_cluster_endpoint}/${var.app_db_database_name}"
