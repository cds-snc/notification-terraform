...
resource "aws_api_gateway_stage" "api" {
  ...
  access_log_settings {
    ...
    format          = "{\"requestId\":\"$context.requestId\", \"ip\": \"$context.identity.sourceIp\", \"caller\":\"$context.identity.caller\", \"requestTime\":\"$context.requestTime\", \"httpMethod\":\"$context.httpMethod\", \"resourcePath\":\"$context.resourcePath\", \"status\":\"$context.status\", \"responseLength\":\"$context.responseLength\", \"xrayTraceId\":\"$context.xrayTraceId\", \"responseLatency\":\"$context.responseLatency\"}"
  }
}
