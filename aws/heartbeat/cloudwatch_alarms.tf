...
#   metric_name         = aws_cloudwatch_log_metric_filter.heartbeat-500-errors-api.metric_transformation[0].name
#   namespace           = aws_cloudwatch_log_metric_filter.heartbeat-500-errors-api.metric_transformation[0].namespace
#   period              = "60"
#   statistic           = "Sum"
#   threshold           = 1
